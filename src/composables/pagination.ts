...
export interface PaginationAPI<TItem, S extends SortKey, TResult extends PaginatedResult<TItem> = PaginatedResult<TItem>> {
    items: Ref<TItem[]>
    total: Ref<number>
    offset: Ref<number>
    limit: Ref<number>
...
export interface UsePaginationOptions<TItem, S extends SortKey, TResult extends PaginatedResult<TItem> = PaginatedResult<TItem>> {
...
export function usePagination<TItem, S extends SortKey, TResult extends PaginatedResult<TItem> = PaginatedResult<TItem>>(
    options: UsePaginationOptions<TItem, S, TResult>,
): PaginationAPI<TItem, S, TResult> {
