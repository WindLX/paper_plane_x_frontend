    ...
    <table class="workspace-table">
      <thead>
        <tr class="text-ppx-text-muted text-left text-sm font-semibold tracking-tight uppercase">
          ...
          <th class="min-w-28 px-2 py-2">
            <SortButton
              :label="t('projectDetail.table.updated')"
