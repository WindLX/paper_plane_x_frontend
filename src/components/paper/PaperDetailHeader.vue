...
<template>
  <header class="workspace-panel space-y-3 p-3.5">
    ...
    <div class="flex flex-col justify-between gap-3">
      ...
      <div class="flex items-center gap-2 overflow-x-auto">
        ...
        <AppButton
          ...
          variant="outline"
          size="xs"
          @click="emit('openProjectLinkModal')"
        >
        ...
        <AppButton
          ...
          variant="outline"
          size="xs"
          :disabled="linkingPaperId === paper.paper_id"
          @click="emit('link', paper.paper_id)"
        >
    ...
    <div class="flex flex-wrap gap-2">
      ...
      >
      <span class="workspace-badge workspace-badge--success">{{ paper.extraction_status }}</span>
      <span class="workspace-badge workspace-badge--info">{{
